    ...
    def clean(self):
        ...
        try:
            ...
            if not user.check_password(password):
                logger.debug("[CLEAN] Password tidak cocok")
            ...
            # Jika password cocok, coba autentikasi
            logger.debug("[CLEAN] Password cocok, mencoba autentikasi")
            ...
            if self.user_cache is None:
                logger.error("[CLEAN] Gagal autentikasi meskipun password benar")
                raise forms.ValidationError(
                    "Terjadi kesalahan saat melakukan autentikasi. Silakan coba lagi.",
            ...
            raise forms.ValidationError(
                "Nama pengguna atau email tidak ditemukan.",
                code='invalid_login',
                params={'username': self.username_field.verbose_name},
            )
